...
HD_PWD='C:/Users/mvbos/Desktop/SoC/SoC_Design/HW2/HW2_part1/HW2_part1.runs/hw2_part1_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2_part1_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw2_part1_lmb_bram_0.tcl
