...
HD_PWD='C:/Users/mvbos/Desktop/SoC/SoC_Design/HW2/HW2_part1/HW2_part1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2_part1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw2_part1_wrapper.tcl -notrace
