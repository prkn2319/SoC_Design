...
#
# Generated by export_simulation on Thu Feb 23 19:24:26 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './hw2_part2.sh' script.

./hw2_part2.sh -reset_run
...
./hw2_part2.sh -noclean_files

For more information on the script, please type './hw2_part2.sh -help'.
